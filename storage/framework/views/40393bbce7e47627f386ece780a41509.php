...
<form method="GET" class="flex gap-3 mb-6">
    <select name="month" class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none">
        <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($m['value']); ?>" <?php echo e($m['value'] == $month ? 'selected' : ''); ?>><?php echo e($m['label']); ?></option>
    ...
    <select name="year" class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none">
        <?php $__currentLoopData = [date('Y'), date('Y')-1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php if($myEntry): ?>
    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl p-5 mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-4xl font-bold mt-1">#<?php echo e($myEntry->rank ?: '–'); ?></p>
        </div>
        <div class="text-right">
            <p class="text-indigo-200 text-sm">Total Points</p>
            <p class="text-3xl font-bold"><?php echo e(number_format($myEntry->total_points)); ?></p>
            <p class="text-indigo-200 text-xs mt-1">
                <?php echo e($myEntry->lending_count); ?> lends · <?php echo e($myEntry->positive_reviews); ?> reviews
            </p>
        </div>
    </div>
<?php endif; ?>
...
<?php $top3 = $entries->take(3); ?>
<?php if($top3->count() >= 3): ?>
    <div class="grid grid-cols-3 gap-4 mb-8">
        <?php $__currentLoopData = [1,0,2]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $podiumPos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $entry = $top3->values()->get($podiumPos); ?>
            <?php if($entry): ?>
                <?php
        ...
        <tbody class="divide-y divide-gray-100">
            <?php $__empty_1 = true; $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="<?php echo e($entry->id === auth()->id() ? 'bg-indigo-50' : 'hover:bg-gray-50'); ?> transition">
                    ...
                    <td class="px-4 py-3 text-right text-gray-600"><?php echo e($entry->lending_count); ?></td>
                    <td class="px-4 py-3 text-right text-gray-600"><?php echo e($entry->positive_reviews); ?></td>
                    <td class="px-4 py-3 text-right font-bold text-indigo-700"><?php echo e(number_format($entry->total_points)); ?></td>
                </tr>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
        <?php $__currentLoopData = $badges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center gap-3 bg-gray-50 rounded-xl p-3">
                ...
                <div>
                    <p class="text-sm font-semibold" style="color: <?php echo e($badge->color); ?>"><?php echo e($badge->name); ?></p>
                    <p class="text-xs text-gray-400"><?php echo e(number_format($badge->required_points)); ?> pts</p>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
