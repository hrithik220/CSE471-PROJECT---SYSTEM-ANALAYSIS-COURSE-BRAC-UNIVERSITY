...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'CampusShare'); ?></title>
    ...
    <aside class="w-64 bg-white border-r border-slate-200 flex flex-col fixed top-0 left-0 h-full z-30 overflow-y-auto">
        ...
        <nav class="flex-1 p-4 space-y-1">
            ...
            <a href="<?php echo e(route('resources.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('resources.index') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('resources.create')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('resources.create') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e(route('map.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('map.*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('reminders.notifications')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('reminders.*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('statistics.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('statistics.*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('leaderboard.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('leaderboard.*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('admin.reports.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('admin.*') ? 'active' : ''); ?>">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="p-4 border-t border-slate-100">
            <div class="flex items-center gap-3 mb-3 px-2">
                ...
                <div class="flex-1 min-w-0">
                    <p class="font-semibold text-slate-800 text-sm truncate"><?php echo e(auth()->user()->name); ?></p>
                    <p class="text-xs text-slate-500">⭐ <?php echo e(auth()->user()->credibility_score); ?></p>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\campusshare_final\resources\views/layouts/app.blade.php ENDPATH**/ ?>