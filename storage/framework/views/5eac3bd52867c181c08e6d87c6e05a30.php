...
fetch('<?php echo e(route("map.resources")); ?>')
    .then(r => r.json())
    .then(resources => {
        if (!resources.length) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\campusshare_final\resources\views/map/index.blade.php ENDPATH**/ ?>